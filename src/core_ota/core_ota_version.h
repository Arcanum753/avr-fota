...
#define CORE_OTA_VERSION 1

// Строковая версия
#define CORE_OTA_VERSION_STR "1"

// Хэш последнего обработанного коммита кода (без учёта *_version.h)
#define CORE_OTA_COMMIT_HASH "681a5ba69c84655cf40093d932ba83ad1e120787"
...
#define CORE_OTA_COMMIT_DATE_STR "2026.09.10 22:15"

// Компоненты даты (для числовых операций)
#define CORE_OTA_COMMIT_YEAR 2026
#define CORE_OTA_COMMIT_MONTH 9
#define CORE_OTA_COMMIT_DAY 10
#define CORE_OTA_COMMIT_HOUR 22
#define CORE_OTA_COMMIT_MINUTE 15

// Полная дата в формате YYYY-MM-DD HH:MM (для отладки)
#define CORE_OTA_COMMIT_DATE "2026-09-10 22:15"

// ============================================================
// ИНФОРМАЦИЯ О ГЕНЕРАЦИИ
// ============================================================

#define CORE_OTA_GENERATED_TIME "2026-09-10 22:38"
#define CORE_OTA_GENERATED_TIMESTAMP "20260910_223839"
