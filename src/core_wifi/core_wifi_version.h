...
#define CORE_WIFI_VERSION 3

// Строковая версия
#define CORE_WIFI_VERSION_STR "3"

// Хэш последнего обработанного коммита кода (без учёта *_version.h)
#define CORE_WIFI_COMMIT_HASH "936295d50b3279fbb8d48bdd106af12aadd559fd"
...
#define CORE_WIFI_COMMIT_DATE_STR "2026.09.12 00:51"

// Компоненты даты (для числовых операций)
#define CORE_WIFI_COMMIT_YEAR 2026
#define CORE_WIFI_COMMIT_MONTH 9
#define CORE_WIFI_COMMIT_DAY 12
#define CORE_WIFI_COMMIT_HOUR 0
#define CORE_WIFI_COMMIT_MINUTE 51

// Полная дата в формате YYYY-MM-DD HH:MM (для отладки)
#define CORE_WIFI_COMMIT_DATE "2026-09-12 00:51"

// ============================================================
// ИНФОРМАЦИЯ О ГЕНЕРАЦИИ
// ============================================================

#define CORE_WIFI_GENERATED_TIME "2026-09-12 17:51"
#define CORE_WIFI_GENERATED_TIMESTAMP "20260912_175116"
