...
1. AVR fOTA. Страница прошивки AVR чипа. Содержит информацию о текущей версии прошивки и предыдущей версии прошивки, а также времени последнего обновления прошивки (не путать со временем сборки). Редактирование fuse битов AVR чипа по маске;
...
Реализована возможность чтения и редактирования fuse битов подключенного чипа по маске. Редактор fuse бит доступен на странице /avr.html , но изначально скрыт. Раскрыть можно нажав на чекбокс **"Expand"**.
Для редактирования любого бита **СТРОГО РЕКОМЕНДУЕТСЯ** сначала изучить документацию к чипу, нажать на кнопочку **Read** и после этого уже произвести запись новых бит кнопкой **Write**. 
За заблокированные чипы автор этого проекта отвественность не несёт.
...
#История версий
1.1.1 добавлена возможность редактировани fuse битов по маске. Сделан веб-интерфейс для этого; 
1.0.1 исправлена страница general.html , не было редактирования информации по avr чипу и проекту;
1.0.0 релиз;