...
**(!)ВНИМЕНИЕ! ESP8266 И AVR ЧИПЫ ДОЛЖНЫ БЫТЬ СОГЛАСОВАНЫ ПО УРОВНЮ НАПРЯЖЕНИЯ ПИТАНИЯ ИЛИ ДОЛЖЕН ИСПОЛЬЗОВАТЬСЯ СОГЛАСОВАТЕЛЬ НПАРЯЖЕНИЙ СИГНАЛЬНЫХ ЛИНИЙ! (!)**
**(!)Автор данного проекта снимает с себя абсолютно всю ответсвенность в случае игноривования данного предупреждения(!)**
|---------|------------------|
